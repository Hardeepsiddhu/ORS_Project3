...
<body class="hm">
	...
	<div>
		<form class="pb-5" action="<%=ORSView.USER_LIST_CTL%>" method="post">
			...
			List lnlist = (List) request.getAttribute("lastName");
			%>
			...
			<div class="row">
               ...
               <%--  &emsp;
                <div class="col-sm-2"><%=HTMLUtility.getList("lastName", String.valueOf(dto.getLastName()), lnlist)%></div>
 --%>
               <%--  <div>
			...
			<div style="margin-bottom: 20px;" class="table-responsive">
				<table class="table table-bordered table-secondary table-hover">
					<thead>
						<tr style="background-color: #54B4D3;">
